...
echo "TERRAFORM INIT"
cd $WORK_DIRECTORY/terraform/ ; terraform init
...
echo ""
cd $WORK_DIRECTORY/terraform ; terraform destroy -auto-approve 
...
echo ""
cd $WORK_DIRECTORY/ansible ; ansible-playbook wordpress_main.yml -i ../terraform/inventory
